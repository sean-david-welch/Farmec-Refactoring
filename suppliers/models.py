...
class Supplier(models.Model):
    ...
    logo_image = models.ImageField(null=True, blank=True, upload_to='suppliers/', default="default.jpg")
    marketing_image = models.ImageField(null=True, blank=True, upload_to='suppliers/', default="default.jpg")
...
class Machine(models.Model):
    supplier = models.ForeignKey(Supplier, on_delete=models.CASCADE, null=True, blank=True)
    name = models.CharField(max_length=200, blank=True, null=True)
    machine_image = models.ImageField(null=True, blank=True, upload_to='suppliers/machines/', default="default.jpg")
    description = models.TextField(blank=True, null=True)
...
class Product(models.Model):
    ...
    name = models.CharField(max_length=200, blank=True, null=True)
    product_image = models.ImageField(null=True, blank=True, upload_to='suppliers/products/', default="default.jpg")
    description = models.TextField(blank=True, null=True)
